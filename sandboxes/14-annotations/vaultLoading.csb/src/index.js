...
async function demo() {
  ...
  const annoIdTest =
    'https://tomcrane.github.io/scratch/cp/annos/test-with-same-id.json';
  const annoIdDifferentId =
    'https://tomcrane.github.io/scratch/cp/annos/test-with-different-id.json';
  const annoIdNoId =
    'https://tomcrane.github.io/scratch/cp/annos/test-with-no-id.json';
  ...
  const annoWithoutId = await cp.vault.load(
  ...
  const annoPageId =
    'https://iiif.wellcomecollection.org/annotations/v3/b29437258/b29437258_0003.jp2/line';
