...
Given an image service, like `https://iiif.wellcomecollection.org/image/b18035723_0001.JP2` we can render the image
represented by the service in a variety of ways.
