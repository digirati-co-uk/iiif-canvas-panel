...
For server rendering, load the browser bundle only on the client. This v2
checkpoint uses an isolated browser runtime; sharing your app's React instance
through the ESM entry is part of the upcoming renderer migration.
