...
The range panel component can show all the ranges within a Manifest, allowing you to style them and add interactive
events that can update other canvas panel components.
...
[Vault helpers](https://iiif-commons.netlify.app/docs/vault-helpers/annotation-targets#supported-targets) documentation.
:::
