...
The metadata panel is rendered as a table with 2 columns, one for the label and
one for the value.
...
- `separator` - When there are multiple IIIF values or labels, what should be
