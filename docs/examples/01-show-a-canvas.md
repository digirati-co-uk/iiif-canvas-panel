...
The [quick start](../intro) showed the basics of rendering a canvas. The power of Canvas Panel is more apparent when you render a canvas that isn't the 99% use case - when the canvas:
 ...
 - has more than one image on a canvas (e.g., a [digitally reconstituted manuscript](https://iiif.io/api/cookbook/recipe/0036-composition-from-multiple-images/) from the IIIF Cookbook) .
...
<canvas-panel
   ...
   manifest-id="https://iiif.io/api/cookbook/recipe/0036-composition-from-multiple-images/manifest.json">
</canvas-panel>
